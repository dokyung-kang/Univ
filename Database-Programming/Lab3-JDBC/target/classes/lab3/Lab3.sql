DROP TABLE DEPT0750 CASCADE CONSTRAINTS;
DROP TABLE EMP00750 CASCADE CONSTRAINTS;

CREATE TABLE DEPT0750 (
...
CREATE TABLE EMP0750 (
	...
	SAL NUMBER(7,2),
	COMM NUMBER(7,2),
	DEPTNO NUMBER(2) REFERENCES DEPT0750(DEPTNO)
);

INSERT INTO DEPT0750 VALUES
...
ALTER TABLE DEPT0750 ADD CONSTRAINT FK_DEPT0750 
	FOREIGN KEY(MANAGER) REFERENCES EMP0750(EMPNO);
