...
class UpdateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        updateBinding.etUpdatePlace.setText(dto.place)
        updateBinding.etUpdateMusic.setText(dto.music)
        ...
        updateBinding.btnUpdateDiary.setOnClickListener{
            ...
            if (updateBinding.etUpdateTitle.text.toString().equals("")){      // 제목 필수 입력 확인
                ...
                dto.place = updateBinding.etUpdatePlace.text.toString()
                dto.music = updateBinding.etUpdateMusic.text.toString()
    ...
    fun updateDiary(dto: DiaryDto): Int {
        ...
        updateValue.put(DiaryDBHelper.COL_MUSIC, dto.music)
